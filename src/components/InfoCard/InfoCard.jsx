...
const InfoCard = () => {
    return (
        <div id="bigPapa" class="cointainer">
            <div id="content" class="row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4 align-self-center col-xl">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl mb-3 mt-1">
                    <div id="picContainer" class="row">
                        <img src={profPic} alt="prof-pic" id="profPic" />
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl align-self-center">
